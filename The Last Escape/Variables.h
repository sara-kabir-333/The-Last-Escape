...
extern int img[25]; // Array to store loading images
...
extern int loadingStep; // Tracks current loading frame
extern int btnHoverState; // Tracks which button is currently hovered (0: None, 1: Play, 2: About, 3: Setting, 4: Exit)
